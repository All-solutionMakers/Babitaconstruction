...
class defaultervehicleadminController extends Controller
{
...

    {
        try {
            ...
            $defaulterVehicleLists = DB::table('vehicleregistations as vreg')
                ...
                ->where('vreg.register_type', '=', 'sale default vehicle')
            ...
            $data = compact('adminData', 'defaulterVehicleLists');

            // dd($defaulterVehicleLists);

            return view('admin_dashboard.defaultervehicle.defaultervehicle')->with($data);
        } catch (Exception $th) {
            //throw $th;
