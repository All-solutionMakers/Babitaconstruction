...
class defaulterVehicleController extends Controller
{
    public function view(Request $request)
    {
        try {
            ...
            return view('user.saleDefaulterVehicleRegisterPage')->with($data);
        } catch (Exception $th) {
            //throw $th;
    ...
    public function insert(Request $request)
    {
        if ($request->isMethod('post')) {
            ...
            try {
                ...
                // $vehicleregistation->listed_by  = $request->id;
                // $vehicleregistation->agreement_id  = $request->id;
                ...
                if ($vehicle_front_image) {
                    ...
                    Image::load($request->vehicle_front_image->path())
                        ...
                        ->optimize()
                        ->save(public_path('vehicledocument/') . $fileName);

                    // Save the file name (or relative path) in the database
                    $vehicleregistation->vehicle_front_img = 'vehicledocument/' . $fileName; //
                }
                ...
                if ($vehicle_side_image_1) {
                    ...
                    // Save the file name (or relative path) in the database
                    $vehicleregistation->vehicle_left_side_img = 'vehicledocument/' . $fileName; //
                }
                ...
                if ($vehicle_side_image_2) {
                    ...
                    // Save the file name (or relative path) in the database
                    $vehicleregistation->vehicle_right_side_img = 'vehicledocument/' . $fileName; //
                }
                ...
                if ($vehicle_back_image) {
                    ...
                    // Save the file name (or relative path) in the database
                    $vehicleregistation->vehicle_back_img = 'vehicledocument/' . $fileName; //
                }
                ...
                if ($permit) {
                    ...
                    // Save the file name (or relative path) in the database
                    $vehicleregistation->permit = 'vehicledocument/' . $fileName; //
                }
                ...
                if ($fitness) {
                    ...
                    // Save the file name (or relative path) in the database
                    $vehicleregistation->fitness = 'vehicledocument/' . $fileName; //
                }
                ...
                if ($polution) {
                    ...
                    // Save the file name (or relative path) in the database
                    $vehicleregistation->polution = 'vehicledocument/' . $fileName; //
                ...
                if ($particular) {
                    ...
                    // Save the file name (or relative path) in the database
                    $vehicleregistation->particular = 'vehicledocument/' . $fileName; //
                ...
                if ($rc) {
                    ...
                    // Save the file name (or relative path) in the database
                    $vehicleregistation->rc = 'vehicledocument/' . $fileName; //
                ...
                if ($insurance) {
                    ...
                    // Save the file name (or relative path) in the database
                    $vehicleregistation->insurance = 'vehicledocument/' . $fileName; //
                ...
                if ($tax) {
                    ...
                    // Save the file name (or relative path) in the database
                    $vehicleregistation->tax = 'vehicledocument/' . $fileName; //
