        ...
        <div class="container">
            <div class="row g-5 justify-content-center mb-5">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="bg-light text-center h-100 p-5">
                        ...
                        <p class="mb-2">9040339519</p>
                        <p class="mb-4">9348879126</p>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="bg-light text-center h-100 p-5">
                        ...
                        <p class="mb-2">info@babitaconstruction.com</p>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="bg-light text-center h-100 p-5">
                        ...
                        <p class="mb-2">Naba Laxmi Niwas (ନବ ଲକ୍ଷ୍ମୀ ନିବାସ), 6V45+34V, Saradeipur Rd, Samantarapurpatna, Uttara, Odisha 751002 (ODISHA)</p>
            ...
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <h1 class="display-5 mb-4">"Get in Touch: We're Here to Help You!"</h1>
                    <p class="mb-4">"Have a question or need assistance? We're here to help! Reach out to us anytime, and
                        we'll get back to you as soon as possible. Fill out the form below or email us at
                        [your-info@babitaconstruction.com]. We look forward to connecting with you!"
