    ...
    <div class="container pt-5 pb-3">
        <div class="row g-5">
            <div class="col-lg-3 col-md-6">
                ...
                {{-- <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>AT-TILAPANGA, P.O.: PHULAPADA,
                    P.S.-BANARPAL, DIST-ANUGUL (ODISHA)</p> --}}

                    <p class="mb-2">
                        <i class="fa fa-map-marker-alt me-3"></i>
                        Naba Laxmi Niwas (ନବ ଲକ୍ଷ୍ମୀ ନିବାସ), 6V45+34V, Saradeipur Rd, Samantarapurpatna, Uttara, Odisha 751002
                    </p>
                <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>9040339519, 9348879126</p>
                <p class="mb-2"><i class="fa fa-envelope me-3"></i>babitaconstruction@gmail.com</p>
...
<div class="container-fluid copyright bg-dark py-4">
    <div class="container text-center">
        <p class="mb-0"> &copy; <a class="fw-semi-bold" href="#">Babita Construction</a> || All Right Reserved.
        </p>
